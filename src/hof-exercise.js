...
const sum = numbers => numbers.reduce((accumulator, current) => { return accumulator + current}, 0)
...
// calculateTotalDeclarative: (items: [{taxable: boolean, price: number}], tax: number) -> number
